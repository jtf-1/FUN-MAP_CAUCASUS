...
function DYNDECK.sc_lch_med(shipID, templateName) -- template for deck template function
...
function DYNDECK.sc_lch_hvy(shipID, templateName) -- template for deck template function
